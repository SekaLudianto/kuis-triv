...
import { KeyboardIcon, SkipForwardIcon, SwitchIcon, ServerIcon } from './components/IconComponents';
...
const App: React.FC = () => {
  ...
  const showDashboardButton = gameState !== GameState.Setup && gameState !== GameState.Connecting;
